...
![kafka 在LinkedIn中部署后各系统形成的拓扑结构](//raw.githubusercontent.com/George5814/blog-pic/master/image/kafka/kafka-topology-1.png "kafka 在LinkedIn中部署后各系统形成的拓扑结构"){:target="_blank"}
...
![可用于支持批量装载（batch loads）的多数据中心拓扑结构的一个例子](//raw.githubusercontent.com/George5814/blog-pic/master/image/kafka/kafka-topology-2.png "可用于支持批量装载（batch loads）的多数据中心拓扑结构的一个例子"){:target="_blank"}
...
![更加高效的方式](//raw.githubusercontent.com/George5814/blog-pic/master/image/kafka/kafka-topology-3.png "更加高效的方式"){:target="_blank"}
