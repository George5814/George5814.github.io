...
![Hadoop生态](//raw.githubusercontent.com/George5814/blog-pic/master/image/hadoop/hadoop-escosystem-1.png)

这是官网上的Hadoop生态图，包含了大部分常用到的Hadoop相关工具软件

![Hadoop生态](//raw.githubusercontent.com/George5814/blog-pic/master/image/hadoop/hadoop-escosystem-2.jpg)

这是以体系从下到上的布局展示的Hadoop生态系统图，言明了各工具软件在体系中所处的位置

![Hadoop生态](//raw.githubusercontent.com/George5814/blog-pic/master/image/hadoop/hadoop-escosystem-3.jpg)

这张图是Hadoop在系统中核心组件与系统的依赖关系

![Hadoop生态](//raw.githubusercontent.com/George5814/blog-pic/master/image/hadoop/hadoop-escosystem-4.png)
...
![Hadoop生态](//raw.githubusercontent.com/George5814/blog-pic/master/image/hadoop/hadoop-escosystem-5.jpg)
...
![Hadoop生态](//raw.githubusercontent.com/George5814/blog-pic/master/image/hadoop/hadoop-escosystem-6.gif)
...
![Hadoop生态](//raw.githubusercontent.com/George5814/blog-pic/master/image/hadoop/hadoop-escosystem-7.jpg)
...
![Hadoop生态](//raw.githubusercontent.com/George5814/blog-pic/master/image/hadoop/hadoop-escosystem-8.png)
...
![Hadoop生态](//raw.githubusercontent.com/George5814/blog-pic/master/image/hadoop/hadoop-escosystem-9.jpg)
...
![Hadoop生态](//raw.githubusercontent.com/George5814/blog-pic/master/image/hadoop/hadoop-escosystem-10.jpg)
...
![Hadoop生态](//raw.githubusercontent.com/George5814/blog-pic/master/image/hadoop/hadoop-escosystem-11.png)

通用性


![Hadoop生态](//raw.githubusercontent.com/George5814/blog-pic/master/image/hadoop/hadoop-escosystem-12.png)

可到处运行

![Hadoop生态](//raw.githubusercontent.com/George5814/blog-pic/master/image/hadoop/hadoop-escosystem-13.png)

易于编程

![Hadoop生态](//raw.githubusercontent.com/George5814/blog-pic/master/image/hadoop/hadoop-escosystem-14.png)
...
![Hadoop生态](//raw.githubusercontent.com/George5814/blog-pic/master/image/hadoop/hadoop-escosystem-15.png)

上图展示的流程包含多个MR任务，每个任务都将中间结果存储到HDFS上——前一个步骤中的reducer为下一个步骤中的mapper提供数据。

![Hadoop生态](//raw.githubusercontent.com/George5814/blog-pic/master/image/hadoop/hadoop-escosystem-16.png)
...
![Hadoop生态](//raw.githubusercontent.com/George5814/blog-pic/master/image/hadoop/hadoop-escosystem-17.png)
...
![Hadoop生态](//raw.githubusercontent.com/George5814/blog-pic/master/image/hadoop/hadoop-escosystem-18.jpg)
...
![Hadoop生态](//raw.githubusercontent.com/George5814/blog-pic/master/image/hadoop/hadoop-escosystem-19.png)
...
译文：
	...
	Flume是一个分布式、可靠的、高可用的有效收集、聚合和转移大量日志文件的服务。它拥有简单灵活的基于数据流的体系结构。它是鲁棒性的，拥有容错可调的可靠性机制、故障转移和恢复机制。使用简单可扩展的可以在线分析应用的数据模型
...
![Hadoop生态](//raw.githubusercontent.com/George5814/blog-pic/master/image/hadoop/hadoop-escosystem-20.jpg)
