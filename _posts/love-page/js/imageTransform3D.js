...
ge1doot.transform3D.Camera = function (setup, func) {
	//this  为ge1doot.transform3D.Camera
//	console.dir(this);
	ge1doot.camera = this;
	this.x  = 0;
	this.y  = 0;
...
ge1doot.transform3D.Triangle.prototype.draw = function () {
 ...
 /* ===================== image constructor 图像构造器========================== */

/**
 * 图像构造器
 * @param {Object} parent 父级元素
 * @param {String} imgSrc 作为纹理的src路径
 * @param {int} lev  级别
